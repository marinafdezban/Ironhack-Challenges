...
def df_status(df_pulls, base_url, key, owner, repo, commits, username, api_token, field_list2):
    ...
    df_pulls['lab_status'] = df_pulls.apply(lambda col: get_commits(base_url,
                                                                    ...
                                                                    username,
                                                                    api_token), axis=1)
    df_status = df_pulls[field_list2]
    return df_status


# And there you have it!!!

def create_csv(df_status, field_sort1, field_name1):
    df_csv = df_status.sort_values(by=field_sort1, ascending=False)
    df_csv.columns = field_name1
